...
const ProjectListing = () => {
  ...
  const fetchData = (page, query, sortBy) => {
    axios
      .get(
        `https://online-project-ho91ilw0z-shashi242.vercel.app/project?limit=${10}&page=${page}&filter=${query}&sort=${sortBy}`
      )
      .then((res) => {
        // console.log(res);
  ...
  const handleUpdate = (value, id) => {
    axios
      .put(
        `https://online-project-ho91ilw0z-shashi242.vercel.app/project/updateStatus?limit=${10}&page=${page}&filter=${query}&sort=${sortBy}`,
        {
          Status: value,
          id: id,
        }
