  ...
  const fetchData = async (tab) => {
    ...
    try {
      const fetch1 = await axios.get(
        "https://online-project-ho91ilw0z-shashi242.vercel.app/project/count"
      );
      const fetch2 = await axios.get(
        "https://online-project-ho91ilw0z-shashi242.vercel.app/project/chart"
      );
        ...
        {!isVertical && (
          <TabList pr={2} boxShadow="xl" borderRadius={5} mr={5}>
            ...
            <Tab
              ...
              mt={5}
            >
              <Image boxSize={5} src={projectListImg} />
            </Tab>
